...
public class LibraryApplication {
	...
	CommandLineRunner runner() {
		return args -> {
			...
			User user1 = new User("admin", pwEncoder.encode("admin"), "amine.kahlaoui01@gmail.com", "Amine", "Kahlaoui", "EL agba ", "27882960", "Mannouba Tunis");
			...
			book10.setReturnDate(LocalDate.of(2023, 12, 26));
			
			book1.setTheUser(user3);
			book1.setReturnDate(LocalDate.of(2023, 12, 05));
